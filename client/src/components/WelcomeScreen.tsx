    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col items-center justify-center flex-grow p-6 bg-gray-50">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-xl font-medium text-center mb-6">Join or Create a Room</h2>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h3 className="text-center text-sm font-medium text-gray-500 mb-4">How It Works</h3>
      ...
      <footer className="bg-white py-3 px-6 text-center text-xs text-gray-500 border-t">
